import { Component, OnInit, PLATFORM_ID, Inject, EventEmitter, Output, SimpleChange, OnChanges, SimpleChanges } from '@angular/core';
...
@Component({
    selector: 'app-flight-new-search-list',
    templateUrl: './flight-new-search-list.component.html',
    styleUrls: ['./flight-new-search-list.component.scss']
})
export class FlightNewSearchListComponent extends BaseChildComponent implements OnChanges, OnInit {
    ...
    onEmit() {
        ...
        console.log(this.viewModel.recentList.length, 'length');
        this.searchEvt.emit({
            dataModel: this.dataModel,
            viewModel: this.viewModel
        });
