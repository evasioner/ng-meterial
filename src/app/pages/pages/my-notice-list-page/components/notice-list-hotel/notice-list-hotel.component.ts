...
export class NoticeListHotelComponent implements OnInit, OnDestroy {
    ...
    detailView(postSeq) {
        ...
        this.bsModalRef = this.bsModalService.show(MyModalNoticeViewComponent, {
