...
@Component({
    selector: 'app-notice-list-airtel',
    templateUrl: './notice-list-airtel.component.html',
    styleUrls: ['./notice-list-airtel.component.scss']
})
export class NoticeListAirtelComponent extends BaseChildComponent implements OnInit, OnDestroy {
