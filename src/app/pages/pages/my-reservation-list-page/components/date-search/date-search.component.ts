...
export class DateSearchComponent extends BaseChildComponent implements OnInit, OnDestroy {
    ...
    openCalendar($tgNum) {
        ...
        // this.bsModalService.show(MyModalCalendarComponent, { initialState, ...configInfo });
    }
