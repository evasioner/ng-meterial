...
import * as componentReducer from './hotel-search-roomtype.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.hotelSearchRoomtypeCompleteState>(pageIndex.hotelSearchRoomtypePageFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.hotelSearchRoomtypesFeatureKey],
);
