...
import * as componentReducer from './flight-search-result-go.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.flightMainSearchGoState>(pageIndex.flightSearchResultGoFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.flightSearchResultGoesFeatureKey]
);
