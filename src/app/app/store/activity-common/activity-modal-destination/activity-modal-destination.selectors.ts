...
import * as componentReducer from './activity-modal-destination.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.activityCommonState>(pageIndex.activityCommonFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.activityModalDestinationsFeatureKey]
);
