...
import * as componentReducer from './activity-search-result-detail-page.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.activitySearchResulDetailState>(pageIndex.activitySearchResultDetailPageFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.activitySearchResultDetailPagesFeatureKey]
);
