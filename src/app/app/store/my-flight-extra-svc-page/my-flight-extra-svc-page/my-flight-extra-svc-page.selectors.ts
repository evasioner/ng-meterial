...
import * as componentReducer from './my-flight-extra-svc-page.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.myFlightExtraSvcState>(pageIndex.myFlightExtraSvcPagesFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.myFlightExtraSvcPagesFeatureKey]
);
