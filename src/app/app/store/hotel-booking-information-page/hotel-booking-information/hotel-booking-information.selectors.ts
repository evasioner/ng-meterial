...
import * as componentReducer from './hotel-booking-information.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.hotelBookingInformationCompleteState>(pageIndex.hotelBookingInformationPageFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.hotelBookingInformationsFeatureKey],
);
