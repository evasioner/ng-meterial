...
import * as componentReducer from './rent-booking-information-page.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.rentBookingInformationState>(pageIndex.rentBookingInformationPageFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.rentBookingInformationPagesFeatureKey]
);
