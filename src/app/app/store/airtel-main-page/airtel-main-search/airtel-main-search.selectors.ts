...
import * as componentReducer from './airtel-main-search.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.airtelMainSearchState>(pageIndex.airtelMainSearchFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.airtelMainSearchesFeatureKey]
);
