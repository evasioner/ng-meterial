...
import * as componentReducer from './flight-booking-information-page.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.flightBookingInformationState>(pageIndex.flightBookingInformationFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.flightBookingInformationPagesFeatureKey]
);
