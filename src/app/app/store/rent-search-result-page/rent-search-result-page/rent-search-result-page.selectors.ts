...
import * as componentReducer from './rent-search-result-page.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.rentSearchResultState>(pageIndex.rentSearchResultPageFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.rentSearchResultPagesFeatureKey]
);
