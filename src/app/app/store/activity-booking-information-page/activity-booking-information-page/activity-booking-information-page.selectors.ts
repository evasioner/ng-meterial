...
import * as componentReducer from './activity-booking-information-page.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.activityCommonState>(pageIndex.activitBookingInformationPageKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.activityBookingInformationPagesFeatureKey]
);
