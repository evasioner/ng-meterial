...
import * as componentReducer from './airtel-search-result-go.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.airtelMainSearchGoState>(pageIndex.airtelSearchResultGoFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.airtelSearchResultGoesFeatureKey]
);
