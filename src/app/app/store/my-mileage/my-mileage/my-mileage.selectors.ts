...
import * as componentReducer from './my-mileage.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.myMileageListPageState>(pageIndex.myMileageListPageFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.myMileagesFeatureKey]
);
