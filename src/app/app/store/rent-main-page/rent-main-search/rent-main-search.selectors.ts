...
import * as componentReducer from './rent-main-search.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.rentState>(pageIndex.rentMainPageFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.rentMainSearchesFeatureKey]
);
