...
import * as componentReducer from './hotel-main-search.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.hotelMainSearchState>(pageIndex.hotelMainSearchFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.hotelMainSearchesFeatureKey],
);
