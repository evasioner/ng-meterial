...
import * as componentReducer from './flight-search-result-come.reducer';


/**
 * createFeatureSelector : 페이지 셀렉터
 */
export const selectPageState = createFeatureSelector<pageIndex.flightMainSearchComeState>(pageIndex.flightSearchResultComeFeatureKey);
...
export const selectComponentState = createSelector(
    selectPageState,
    state => state[componentReducer.flightSearchResultComesFeatureKey]
);
