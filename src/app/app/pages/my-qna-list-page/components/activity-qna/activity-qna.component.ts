...
@Component({
  selector: 'app-activity-qna',
  templateUrl: './activity-qna.component.html',
  styleUrls: ['./activity-qna.component.scss']
})
export class ActivityQnaComponent implements OnInit {
