...
@Component({
    selector: 'app-rent-new-search-list',
    templateUrl: './rent-new-search-list.component.html',
    styleUrls: ['./rent-new-search-list.component.scss']
})
export class RentNewSearchListComponent extends BaseChildComponent implements OnInit {
    viewModel: any;
    dataModel: any;
