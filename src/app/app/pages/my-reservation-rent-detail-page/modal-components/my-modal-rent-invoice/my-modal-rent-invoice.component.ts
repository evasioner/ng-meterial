...
@Component({
    selector: 'app-my-modal-rent-invoice',
    templateUrl: './my-modal-rent-invoice.component.html',
    styleUrls: ['./my-modal-rent-invoice.component.scss']
})
export class MyModalRentInvoiceComponent extends BaseChildComponent implements OnInit {
    @Input() rq: any;
    ...
    */
    async hotelInvoice($request) {
        await this.apiBookingSvc.POST_RENT_INVOICE($request)
            .toPromise()
            .then((res: any) => {
