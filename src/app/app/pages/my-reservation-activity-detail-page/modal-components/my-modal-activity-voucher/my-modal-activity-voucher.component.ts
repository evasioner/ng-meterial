...
@Component({
    selector: 'app-my-modal-activity-voucher',
    templateUrl: './my-modal-activity-voucher.component.html',
    styleUrls: ['./my-modal-activity-voucher.component.scss']
})
export class MyModalActivityVoucherComponent extends BaseChildComponent implements OnInit {
    @Input() rq: any;
    ...
    */
    async hotelInvoice($request) {
        await this.apiBookingSvc.POST_ACTIVITY_VOUCHER($request)
            .toPromise()
            .then((res: any) => {
