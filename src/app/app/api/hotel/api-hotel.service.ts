...
export class ApiHotelService {
     ...
     * 추천 호텔 조회
     */
    POST_HOTEL_RECOMMEND($body?: any, $opt?: Object) {
     ...
     * 호텔 검색
     */
    POST_HOTEL_LIST($body?: any, $opt?: Object) {
     ...
     * 호텔 지도 검색
     */
    POST_HOTEL_MAP($body?: any, $opt?: Object) {
     ...
     * 호텔 현재 상황 조회
     */
    POST_HOTEL_STATS($body?: any, $opt?: Object) {
     ...
     * 호텔 객실 검색
     */
    POST_HOTEL_ROOM_LIST($body?: any, $opt?: Object) {
     ...
     * 호텔 차지 컨디션
     */
    POST_HOTEL_ROOM_CONDITION($body?: any, $opt?: Object) {
     ...
     * 호텔 객실 정보
     */
    POST_HOTEL_ROOM_INFORMATION($body?: any, $opt?: Object) {
     ...
     * 호텔 상세정보
     */
    POST_HOTEL_INFORMATION($body?: any, $opt?: Object) {
     ...
     * 호텔 리뷰 보기
     */
    POST_HOTEL_REVIEW_LIST($body?: any, $opt?: Object) {
     ...
     * 호텔 리뷰 쓰기
     */
    POST_HOTEL_REVIEW_WRITE($body?: any, $opt?: Object) {
     ...
     * 호텔 위시에 추가
     */
    POST_HOTEL_BASKET($body?: any, $opt?: Object) {
     ...
     * 호텔 요금 알리미에 추가
     */
    POST_HOTEL_ALERT($body?: any, $opt?: Object) {
     ...
     * 호텔 멥버쉽카드 입력
     */
    POST_HOTEL_MEMEBERSHIP($body?: any, $opt?: Object) {
    ...
    /**
       * 호텔 예약 취소하기
       */
    POST_HOTEL_CANCEL($body?: any, $opt?: Object) {
    ...
    PUT_HOTEL_BASKET($body?: any, $opt?: Object) {
