...
export class ApiMypageService {
    ...
    // 항공 예약 상세
    POST_BOOKING_FLIGHT_DETAIL($body?: any, $opt?: Object) {
        return this.httpPost('/booking/flight/detail', $body, $opt);
    }

    // 호텔 예약 상세
    POST_BOOKING_HOTEL_DETAIL($body?: any, $opt?: Object) {
        return this.httpPost('/booking/hotel/detail', $body, $opt);
    }

    // 렌터카 예약 상세
    POST_BOOKING_RENT_DETAIL($body?: any, $opt?: Object) {
        return this.httpPost('/booking/rent/detail', $body, $opt);
    }

    POST_BOOKING_ACTIVITY_DETAIL($body?: any, $opt?: Object) {
        return this.httpPost('/booking/activity/detail', $body, $opt);
    }

    // FAQ 리스트
    POST_MYPAGE_FAQ($body?: any, $opt?: Object) {
        return this.httpPost('/my-page/faq', $body, $opt);
    }

    // FAQ 상세
    POST_MYPAGE_FAQ_DETAIL($body?: any, $opt?: Object) {
        return this.httpPost('/my-page/faq/detail', $body, $opt);
    }

    // 공지사항 리스트
    POST_MYPAGE_NOTICE($body?: any, $opt?: Object) {
        return this.httpPost('/my-page/notice', $body, $opt);
    }

    // 공지사항 상세
    POST_MYPAGE_NOTICE_DETAIL($body?: any, $opt?: Object) {
    ...
    // 이용후기
    POST_REVIEW_LIST($body?: any, $opt?: Object) {
        return this.httpPost('/my-page/review/list', $body, $opt);
    }
    // QNA
    POST_QNA($body?: any, $opt?: Object) {
        return this.httpPost('/my-page/qna', $body, $opt);
    }
    // QNA
    PUT_QNA($body?: any, $opt?: Object) {
