...
export class ApiBookingService {
   ...
   */
     ...
     * 내 여행자 목록
     */
    POST_BOOKING_TRAVELER($body?: any, $opt?: any) {
        return this.httpPost('/booking/traveler', $body, $opt);
    }

    POST_E_TICKET($body?: any, $opt?: any) {
    ...
    * 항공 예약 완료 정보
    */
    POST_BOOKING_FLIGHT_SUMMARY($body?: any, $opt?: any) {
    ...
    POST_BOOKING_DISCOUNT_INFO(body?: any, opt?: any): Observable<any> {
        return this.httpPost('/booking/discount-info', body, opt);
    }

    POST_BOOKING_V2(body?: any, opt?: any): Observable<any> {
        return this.httpPost('/booking/v2', body, opt);
    }

    httpPost($url, $body?: any, $opt?: any): Observable<any> {
